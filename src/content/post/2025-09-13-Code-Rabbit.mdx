...
The comment themsleves are very well structured, and also comes with a nice dose of humor.
The small ascii bunny while waiting for the review with a quote is a nice touch (see below).

<center><img src="/blog/coderabbit/pr-cr.png" alt="A CodeRabbit comment on a PR" class="w-3/4" /></center>
...
Which means that 28% of the findings were not much interesting, but also that 72% of the findings were relevant, of which a bit less than 3 over 4 (51/72 =~ 71%) brought actual value.
