...
description: "Frequently asked questions about installing and setting up Lychee."
sidebar:
  order: 2
---
...
The process is described [here](/docs/administration/upgrade/).
...
Yes, the process is described [here](/docs/administration/advanced-setups/#hosting-lychee-in-a-subpath-with-apache).
