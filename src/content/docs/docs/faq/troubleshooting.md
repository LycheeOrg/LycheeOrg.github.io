...
description: "Solutions for common issues when running Lychee."
sidebar:
  order: 3
---
...
Verify that the rewrite rules of your server are correctly applied. See [here](/docs/administration/upgrade/#using-apache).

### I have an error 404 and I'm using Nginx, what can I do?

Verify that the rewrite rules of your server are correctly applied. See [here](/docs/administration/upgrade/#using-nginx).
...
You will need ffmpeg installed on your server, and to have installed php-ffmpeg using composer as detailed in the [Installation Guide](/docs/getting-started/installation/).

Once this is taken care of, check that the
[`has_ffmpeg` setting](/docs/getting-started/settings/) is set to `1`.  Lychee can reset it
