---
title: "Docker"
description: "Deploy Lychee using Docker and Docker Compose with FrankenPHP."
sidebar:
  order: 2
---
...
**Important:** If you're upgrading from Version 6 to Version 7, you must update your volume mounts. See the [upgrade documentation](/docs/administration/upgrade/) for migration steps.
...
See the detailed [upgrade documentation](/docs/administration/upgrade/#upgrading-lychee-docker-installations-from-v6-to-v7) for complete migration instructions, including:
