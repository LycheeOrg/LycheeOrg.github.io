---
title: "Release Notes"
description: "Changelog and release notes for all Lychee versions."
sidebar:
  order: 1
---
...
* `new` #4581 : Add support for more file secret by @ildyria.
...
* `new` #4553 : Add table relation cache for smart albums by @ildyria.
  > We now support caching the thumbnails of smart albums. This will improve the performance of the gallery page in cases of large number of photos.
...
* `fix` #4568 : Do not watermark placeholders by @ildyria.
  > When using the watermark feature, the placeholder were also considered as candidates, which is stupid and was crashing the job.
  > They are now properly executed.
...
* `klo` #4590 : Notes on sorting: Lexicographic vs Natural by @ildyria.
  > Add explanations on the difference between lexicographic and natural sorting, and the consequences of chosing one over another.
...
* `fix` #4464 : Add missing tile for bulk album edit by @ildyria.
* `fix` #4463 : Add configurable sharable preview by @ildyria.
...
Please refer to [External tracking with Matomo, Google Analytics & Co](/docs/administration/external-tracking/) for examples.
#### Changes
