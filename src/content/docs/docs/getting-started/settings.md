---
title: "Settings"
description: "UI settings and database configuration options for Lychee."
sidebar:
  order: 4
---
...
Note that these settings determine the defaults but the person viewing the gallery is free to override them. The overlay can be toggled on/off by clicking on the image in the photo view, and the data displayed can be changed using the `o` [keyboard shortcut](/docs/usage/keyboard/).
...
The administrator's username and password, encoded using `bcrypt`. If you ever forget either of them and can't access your gallery, see [this FAQ](/docs/faq/general/#how-to-reset-username-and-password).
