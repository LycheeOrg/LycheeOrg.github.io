---
title: "Honeypot & Fail2Ban"
description: "Set up honeypot security and Fail2Ban integration for Lychee."
sidebar:
  order: 5
---
...
:::note
It will also ban you from your own website if you do a bad request.
:::
...
:::tip
**Fail2ban is not provided with Lychee**. It is an additional software that you will need to [install it yourself](https://www.fail2ban.org/wiki/index.php/Downloads).
:::
