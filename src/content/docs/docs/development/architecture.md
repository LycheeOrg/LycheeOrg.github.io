---
title: "Architecture"
description: "Overview of Lychee's Laravel-based architecture."
sidebar:
  order: 1
---
...
![https://cdn.auth0.com/blog/laravel-auth/mvc-diagram.png](/docs/img/mvc-diagram.png)

A detailed description of the directory structure is provided [here](/docs/development/architecture/).
