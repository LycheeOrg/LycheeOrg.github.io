...
Verify that the rewrite rules of your server are correctly applied. See the Nginx section of the [installation instructions](installation.html#web-server-configuration).
