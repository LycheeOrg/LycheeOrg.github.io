...
server {
    ...
    #Required: unless the request is for a valid file (image, js, css, etc.), send to bootstrap
    ...
    #Optional: Serve requests for / to index.php (via index directive), otherwise serve files with the specified
