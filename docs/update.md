...
2. Replace all existing files, excluding `public/uploads/` and `public/dist/user.css` (and `database/database.sqlite` if using **SQLite** as your database, also .env has to stay)
