...
var _templateObject = _taggedTemplateLiteral(["<input class='text' name='title' type='text' maxlength='50' placeholder='$", "' value='$", "'>"], ["<input class='text' name='title' type='text' maxlength='50' placeholder='$", "' value='$", "'>"]),
    ...
    _templateObject10 = _taggedTemplateLiteral(["<svg class='iconic ", "'><use xlink:href='#", "' /></svg>"], ["<svg class='iconic ", "'><use xlink:href='#", "' /></svg>"]),
    _templateObject11 = _taggedTemplateLiteral(["<div class='divider'><h1>", "</h1></div>"], ["<div class='divider'><h1>", "</h1></div>"]),
    _templateObject12 = _taggedTemplateLiteral(["<div id='", "' class='edit'>", "</div>"], ["<div id='", "' class='edit'>", "</div>"]),
    _templateObject13 = _taggedTemplateLiteral(["<div id='multiselect' style='top: ", "px; left: ", "px;'></div>"], ["<div id='multiselect' style='top: ", "px; left: ", "px;'></div>"]),
    ...
    _templateObject17 = _taggedTemplateLiteral(["<a><span title='Camera Date'>", "</span>", "</a>"], ["<a><span title='Camera Date'>", "</span>", "</a>"]),
    _templateObject18 = _taggedTemplateLiteral(["<a>", "</a>"], ["<a>", "</a>"]),
    _templateObject19 = _taggedTemplateLiteral(["\n\t\t\t\t<div class='badges'>\n\t\t\t\t\t<a class='badge ", " icn-star'>", "</a>\n\t\t\t\t\t<a class='badge ", " icn-share'>", "</a>\n\t\t\t\t</div>\n\t\t\t\t"], ["\n\t\t\t\t<div class='badges'>\n\t\t\t\t\t<a class='badge ", " icn-star'>", "</a>\n\t\t\t\t\t<a class='badge ", " icn-share'>", "</a>\n\t\t\t\t</div>\n\t\t\t\t"]),
    _templateObject20 = _taggedTemplateLiteral(["\n\t\t<div id=\"image_overlay\"><h1>$", "</h1>\n\t\t<p>", " at ", ", ", " ", "<br>\n\t\t", " ", "</p>\n\t\t</div>\n\t"], ["\n\t\t<div id=\"image_overlay\"><h1>$", "</h1>\n\t\t<p>", " at ", ", ", " ", "<br>\n\t\t", " ", "</p>\n\t\t</div>\n\t"]),
    _templateObject21 = _taggedTemplateLiteral(["<video width=\"auto\" height=\"auto\" id='image' controls class='", "' autoplay><source src='", "'>Your browser does not support the video tag.</video>"], ["<video width=\"auto\" height=\"auto\" id='image' controls class='", "' autoplay><source src='", "'>Your browser does not support the video tag.</video>"]),
    _templateObject22 = _taggedTemplateLiteral(["<img id='image' class='", "' src='", "' draggable='false'>"], ["<img id='image' class='", "' src='", "' draggable='false'>"]),
    _templateObject23 = _taggedTemplateLiteral(["<div class='no_content fadeIn'>", ""], ["<div class='no_content fadeIn'>", ""]),
    _templateObject24 = _taggedTemplateLiteral(["<p>", "</p>"], ["<p>", "</p>"]),
    _templateObject25 = _taggedTemplateLiteral(["\n\t\t\t<h1>$", "</h1>\n\t\t\t<div class='rows'>\n\t\t\t"], ["\n\t\t\t<h1>$", "</h1>\n\t\t\t<div class='rows'>\n\t\t\t"]),
    _templateObject26 = _taggedTemplateLiteral(["\n\t\t\t\t<div class='row'>\n\t\t\t\t\t<a class='name'>", "</a>\n\t\t\t\t\t<a class='status'></a>\n\t\t\t\t\t<p class='notice'></p>\n\t\t\t\t</div>\n\t\t\t\t"], ["\n\t\t\t\t<div class='row'>\n\t\t\t\t\t<a class='name'>", "</a>\n\t\t\t\t\t<a class='status'></a>\n\t\t\t\t\t<p class='notice'></p>\n\t\t\t\t</div>\n\t\t\t\t"]),
    _templateObject27 = _taggedTemplateLiteral(["<a class='tag'>$", "<span data-index='", "'>", "</span></a>"], ["<a class='tag'>$", "<span data-index='", "'>", "</span></a>"]),
    _templateObject28 = _taggedTemplateLiteral(["<div class='empty'>", "</div>"], ["<div class='empty'>", "</div>"]),
    _templateObject29 = _taggedTemplateLiteral(["<div class=\"users_view_line\">\n\t\t\t<p id=\"UserData", "\">\n\t\t\t<input name=\"id\" type=\"hidden\" value=\"", "\" />\n\t\t\t<input class=\"text\" name=\"username\" type=\"text\" value=\"$", "\" placeholder=\"username\" />\n\t\t\t<input class=\"text\" name=\"password\" type=\"text\" placeholder=\"new password\" />\n\t\t\t<span class=\"choice\">\n\t\t\t<label>\n\t\t\t<input type=\"checkbox\" name=\"upload\" />\n\t\t\t<span class=\"checkbox\"><svg class=\"iconic \"><use xlink:href=\"#check\"></use></svg></span>\n\t\t\t</label>\n\t\t\t</span>\n\t\t\t<span class=\"choice\">\n\t\t\t<label>\n\t\t\t<input type=\"checkbox\" name=\"lock\" />\n\t\t\t<span class=\"checkbox\"><svg class=\"iconic \"><use xlink:href=\"#check\"></use></svg></span>\n\t\t\t</label>\n\t\t\t</span>\n\t\t\t</p>\n\t\t\t<a id=\"UserUpdate", "\"  class=\"basicModal__button basicModal__button_OK\">Save</a>\n\t\t\t<a id=\"UserDelete", "\"  class=\"basicModal__button basicModal__button_DEL\">Delete</a>\n\t\t</div>\n\t\t"], ["<div class=\"users_view_line\">\n\t\t\t<p id=\"UserData", "\">\n\t\t\t<input name=\"id\" type=\"hidden\" value=\"", "\" />\n\t\t\t<input class=\"text\" name=\"username\" type=\"text\" value=\"$", "\" placeholder=\"username\" />\n\t\t\t<input class=\"text\" name=\"password\" type=\"text\" placeholder=\"new password\" />\n\t\t\t<span class=\"choice\">\n\t\t\t<label>\n\t\t\t<input type=\"checkbox\" name=\"upload\" />\n\t\t\t<span class=\"checkbox\"><svg class=\"iconic \"><use xlink:href=\"#check\"></use></svg></span>\n\t\t\t</label>\n\t\t\t</span>\n\t\t\t<span class=\"choice\">\n\t\t\t<label>\n\t\t\t<input type=\"checkbox\" name=\"lock\" />\n\t\t\t<span class=\"checkbox\"><svg class=\"iconic \"><use xlink:href=\"#check\"></use></svg></span>\n\t\t\t</label>\n\t\t\t</span>\n\t\t\t</p>\n\t\t\t<a id=\"UserUpdate", "\"  class=\"basicModal__button basicModal__button_OK\">Save</a>\n\t\t\t<a id=\"UserDelete", "\"  class=\"basicModal__button basicModal__button_DEL\">Delete</a>\n\t\t</div>\n\t\t"]),
    ...
    _templateObject40 = _taggedTemplateLiteral(["<p>", " ", " ", " ", "</p>"], ["<p>", " ", " ", " ", "</p>"]),
    _templateObject41 = _taggedTemplateLiteral(["<p>", " <input class='text' name='description' type='text' maxlength='800' placeholder='", "' value='$", "'></p>"], ["<p>", " <input class='text' name='description' type='text' maxlength='800' placeholder='", "' value='$", "'></p>"]),
    _templateObject42 = _taggedTemplateLiteral(["<input class='text' name='tags' type='text' maxlength='800' placeholder='Tags' value='$", "'>"], ["<input class='text' name='tags' type='text' maxlength='800' placeholder='Tags' value='$", "'>"]),
    _templateObject43 = _taggedTemplateLiteral(["<span class='attr_", "'>$", "</span>"], ["<span class='attr_", "'>$", "</span>"]),
...
album.buildMessage = function (albumIDs, albumID, op1, op2, ops) {
	...
	if (albumIDs.length === 1) {
		...
		msg = lychee.html(_templateObject6, lychee.locale[op1], sTitle, lychee.locale[op2], title);
	} else {

		msg = lychee.html(_templateObject7, lychee.locale[ops], title);
	}
...
album.delete = function (albumIDs) {
	...
	if (albumIDs.toString() === '0') {
		...
		msg = lychee.html(_templateObject8, lychee.locale['DELETE_ALBUM_CONFIRMATION_1'], albumTitle, lychee.locale['DELETE_ALBUM_CONFIRMATION_2']);
	} else {

		action.title = lychee.locale['DELETE_ALBUMS_QUESTION'];
		cancel.title = lychee.locale['KEEP_ALBUMS'];

		msg = lychee.html(_templateObject9, lychee.locale['DELETE_ALBUMS_CONFIRMATION_1'], albumIDs.length, lychee.locale['DELETE_ALBUMS_CONFIRMATION_2']);
	}
...
api.post = function (fn, params, callback) {
    ...
    if(fn == 'Session::init')
    {
        data = `{"config":{"version":"update_030208","checkForUpdates":"1","lang":"en","justified_layout":"1","image_overlay":"1","default_license":"CC0","small_max_width":"0","small_max_height":"360","medium_max_width":"1920","medium_max_height":"1080","lang_available":["\u7b80\u4f53\u4e2d\u6587","nl","en","fr","de","sv"]},"status":1,"locale":{"USERNAME":"username","PASSWORD":"password","ENTER":"Enter","CANCEL":"Cancel","SIGN_IN":"Sign In","CLOSE":"Close","SETTINGS":"Settings","USERS":"Users","SHARING":"Sharing","CHANGE_LOGIN":"Change Login","CHANGE_SORTING":"Change Sorting","SET_DROPBOX":"Set Dropbox","ABOUT_LYCHEE":"About Lychee","DIAGNOSTICS":"Diagnostics","LOGS":"Show Logs","SIGN_OUT":"Sign Out","UPDATE_AVAILABLE":"Update available!","DEFAULT_LICENSE":"Default license for new uploads:","SET_LICENSE":"Set License","SMART_ALBUMS":"Smart albums","SHARED_ALBUMS":"Shared albums","ALBUMS":"Albums","PHOTOS":"Pictures","RENAME":"Rename","RENAME_ALL":"Rename All","MERGE":"Merge","MERGE_ALL":"Merge All","MAKE_PUBLIC":"Make Public","SHARE_ALBUM":"Share Album","SHARE_PHOTO":"Share Photo","DOWNLOAD_ALBUM":"Download Album","ABOUT_ALBUM":"About Album","DELETE_ALBUM":"Delete Album","DELETE_ALBUM_QUESTION":"Delete Album and Photos","KEEP_ALBUM":"Keep Album","DELETE_ALBUM_CONFIRMATION_1":"Are you sure you want to delete the album","DELETE_ALBUM_CONFIRMATION_2":"and all of the photos it contains? This action can't be undone!","DELETE_ALBUMS_QUESTION":"Delete Albums and Photos","KEEP_ALBUMS":"Keep Albums","DELETE_ALBUMS_CONFIRMATION_1":"Are you sure you want to delete all","DELETE_ALBUMS_CONFIRMATION_2":"selected albums and all of the photos they contain? This action can't be undone!","DELETE_UNSORTED_CONFIRM":"Are you sure you want to delete all photos from 'Unsorted'?<br>This action can't be undone!","CLEAR_UNSORTED":"Clear Unsorted","KEEP_UNSORTED":"Keep Unsorted","EDIT_SHARING":"Edit Sharing","MAKE_PRIVATE":"Make Private","CLOSE_ALBUM":"Close Album","CLOSE_PHOTO":"Close Photo","ADD":"Add","MOVE":"Move","MOVE_ALL":"Move All","DUPLICATE":"Duplicate","DUPLICATE_ALL":"Duplicate All","COPY_TO":"Copy to...","COPY_ALL_TO":"Copy All to...","DELETE":"Delete","DELETE_ALL":"Delete All","DOWNLOAD":"Download","UPLOAD_PHOTO":"Upload Photo","IMPORT_LINK":"Import from Link","IMPORT_DROPBOX":"Import from Dropbox","IMPORT_SERVER":"Import from Server","NEW_ALBUM":"New Album","TITLE_NEW_ALBUM":"Enter a title for the new album:","UNTITLED":"Untilted","UNSORTED":"Unsorted","STARRED":"Starred","RECENT":"Recent","PUBLIC":"Public","NUM_PHOTOS":"Photos","CREATE_ALBUM":"Create Album","STAR_PHOTO":"Star Photo","STAR":"Star","STAR_ALL":"Star All","TAGS":"Tags","TAGS_ALL":"Tags All","UNSTAR_PHOTO":"Unstar Photo","FULL_PHOTO":"Full Photo","ABOUT_PHOTO":"About Photo","DIRECT_LINK":"Direct Link","ALBUM_ABOUT":"About","ALBUM_BASICS":"Basics","ALBUM_TITLE":"Title","ALBUM_NEW_TITLE":"Enter a new title for this album:","ALBUMS_NEW_TITLE_1":"Enter a title for all","ALBUMS_NEW_TITLE_2":"selected albums:","ALBUM_SET_TITLE":"Set Title","ALBUM_DESCRIPTION":"Description","ALBUM_NEW_DESCRIPTION":"Enter a new description for this album:","ALBUM_SET_DESCRIPTION":"Set Description","ALBUM_ALBUM":"Album","ALBUM_CREATED":"Created","ALBUM_IMAGES":"Images","ALBUM_SHARING":"Share","ALBUM_SHR_YES":"YES","ALBUM_SHR_NO":"No","ALBUM_PUBLIC":"Public","ALBUM_HIDDEN":"Hidden","ALBUM_HIDDEN_EXPL":"Only people with the direct link can view this album.","ALBUM_DOWNLOADABLE":"Downloadable","ALBUM_DOWNLOADABLE_EXPL":"Visitors of your Lychee can download this album.","ALBUM_PASSWORD":"Password","ALBUM_PASSWORD_PROT":"Password protected","ALBUM_PASSWORD_PROT_EXPL":"Album only accessible with a valid password.","ALBUM_PASSWORD_REQUIRED":"This album is protected by a password. Enter the password below to view the photos of this album:","ALBUM_MERGE_1":"Are you sure you want to merge the album","ALBUM_MERGE_2":"into the album","ALBUMS_MERGE":"Are you sure you want to merge all selected albums into the album","MERGE_ALBUM":"Merge Albums","DONT_MERGE":"Don't Merge","ALBUM_MOVE_1":"Are you sure you want to move the album","ALBUM_MOVE_2":"into the album","ALBUMS_MOVE":"Are you sure you want to move all selected albums into the album","MOVE_ALBUMS":"Move Albums","NOT_MOVE_ALBUMS":"Don't Move","ROOT":"Root","ALBUM_REUSE":"Reuse","ALBUM_LICENSE":"License","ALBUM_SET_LICENSE":"Set License","ALBUM_LICENSE_HELP":"Need help choosing?","ALBUM_LICENSE_NONE":"None","ALBUM_RESERVED":"All Rights Reserved","PHOTO_ABOUT":"About","PHOTO_BASICS":"Basics","PHOTO_TITLE":"Title","PHOTO_NEW_TITLE":"Enter a new title for this photo:","PHOTO_SET_TITLE":"Set Title","PHOTO_UPLOADED":"Uploaded","PHOTO_DESCRIPTION":"Description","PHOTO_NEW_DESCRIPTION":"Enter a new description for this photo:","PHOTO_SET_DESCRIPTION":"Set Description","PHOTO_NEW_LICENSE":"Add a License","PHOTO_SET_LICENSE":"Set License","PHOTO_LICENSE":"License","PHOTO_REUSE":"Reuse","PHOTO_LICENSE_NONE":"None","PHOTO_RESERVED":"All Rights Reserved","PHOTO_IMAGE":"Image","PHOTO_SIZE":"Size","PHOTO_FORMAT":"Format","PHOTO_RESOLUTION":"Resolution","PHOTO_TAGS":"Tags","PHOTO_NOTAGS":"No Tags","PHOTO_NEW_TAGS":"Enter your tags for this photo. You can add multiple tags by separating them with a comma:","PHOTO_NEW_TAGS_1":"Enter your tags for all","PHOTO_NEW_TAGS_2":"selected photos. Existing tags will be overwritten. You can add multiple tags by separating them with a comma:","PHOTO_SET_TAGS":"Set Tags","PHOTO_CAMERA":"Camera","PHOTO_CAPTURED":"Captured","PHOTO_MAKE":"Make","PHOTO_TYPE":"Type\/Model","PHOTO_SHUTTER":"Shutter Speed","PHOTO_APERTURE":"Aperture","PHOTO_FOCAL":"Focal Length","PHOTO_ISO":"ISO","PHOTO_SHARING":"Sharing","PHOTO_SHR_PLUBLIC":"Public","PHOTO_SHR_ALB":"Yes (Album)","PHOTO_SHR_PHT":"Yes (Photo)","PHOTO_SHR_NO":"No","PHOTO_DELETE":"Delete Photo","PHOTO_KEEP":"Keep Photo","PHOTO_DELETE_1":"Are you sure you want to delete the photo","PHOTO_DELETE_2":"? This action can't be undone!","PHOTO_DELETE_ALL_1":"Are you sure you want to delete all","PHOTO_DELETE_ALL_2":"selected photo? This action can't be undone!","PHOTOS_NEW_TITLE_1":"Enter a title for all","PHOTOS_NEW_TITLE_2":"selected photos:","PHOTO_MAKE_PRIVATE_ALBUM":"This photo is located in a public album. To make this photo private or public, edit the visibility of the associated album.","PHOTO_SHOW_ALBUM":"Show Album","LOADING":"Loading","ERROR":"Error","ERROR_TEXT":"Whoops, it looks like something went wrong. Please reload the site and try again!","ERROR_DB_1":"Unable to connect to host database because access was denied. Double-check your host, username and password and ensure that access from your current location is permitted.","ERROR_DB_2":"Unable to create the database. Double-check your host, username and password and ensure that the specified user has the rights to modify and add content to the database.","ERROR_CONFIG_FILE":"Unable to save this configuration. Permission denied in <b>'data\/'<\/b>. Please set the read, write and execute rights for others in <b>'data\/'<\/b> and <b>'uploads\/'<\/b>. Take a look at the readme for more information.","ERROR_UNKNOWN":"Something unexpected happened. Please try again and check your installation and server. Take a look at the readme for more information.","ERROR_LOGIN":"Unable to save login. Please try again with another username and password!","SUCCESS":"OK","RETRY":"Retry","SETTINGS_SUCCESS_LOGIN":"Login Info updated.","SETTINGS_SUCCESS_SORT":"Sorting order updated.","SETTINGS_SUCCESS_DROPBOX":"Dropbox Key updated.","SETTINGS_SUCCESS_LANG":"Language updated","SETTINGS_SUCCESS_LAYOUT":"Layout updated","SETTINGS_SUCCESS_IMAGE_OVERLAY":"EXIF Overlay setting updated","SETTINGS_SUCCESS_LICENSE":"Default license updated","DB_INFO_TITLE":"Enter your database connection details below:","DB_INFO_HOST":"Database Host (optional)","DB_INFO_USER":"Database Username","DB_INFO_PASSWORD":"Database Password","DB_INFO_TEXT":"Lychee will create its own database. If required, you can enter the name of an existing database instead:","DB_NAME":"Database Name (optional)","DB_PREFIX":"Table prefix (optional)","DB_CONNECT":"Connect","LOGIN_TITLE":"Enter a username and password for your installation:","LOGIN_USERNAME":"New Username","LOGIN_PASSWORD":"New Password","LOGIN_CREATE":"Create Login","PASSWORD_TITLE":"Enter your current password:","USERNAME_CURRENT":"Current Username","PASSWORD_CURRENT":"Current Password","PASSWORD_TEXT":"Your username and password will be changed to the following:","PASSWORD_CHANGE":"Change Login","EDIT_SHARING_TITLE":"Edit Sharing","EDIT_SHARING_TEXT":"The sharing-properties of this album will be changed to the following:","SHARE_ALBUM_TEXT":"This album will be shared with the following properties:","SORT_ALBUM_BY_1":"Sort albums by","SORT_ALBUM_BY_2":"in an","SORT_ALBUM_BY_3":"order.","SORT_ALBUM_SELECT_1":"Creation Time","SORT_ALBUM_SELECT_2":"Title","SORT_ALBUM_SELECT_3":"Description","SORT_ALBUM_SELECT_4":"Public","SORT_ALBUM_SELECT_5":"Latest Take Date","SORT_ALBUM_SELECT_6":"Oldest Take Date","SORT_PHOTO_BY_1":"Sort photos by","SORT_PHOTO_BY_2":"in an","SORT_PHOTO_BY_3":"order.","SORT_PHOTO_SELECT_1":"Upload Time","SORT_PHOTO_SELECT_2":"Take Date","SORT_PHOTO_SELECT_3":"Title","SORT_PHOTO_SELECT_4":"Description","SORT_PHOTO_SELECT_5":"Public","SORT_PHOTO_SELECT_6":"Star","SORT_PHOTO_SELECT_7":"Photo Format","SORT_ASCENDING":"Ascending","SORT_DESCENDING":"Descending","SORT_CHANGE":"Change Sorting","DROPBOX_TITLE":"Set Dropbox Key","DROPBOX_TEXT":"In order to import photos from your Dropbox, you need a valid drop-ins app key from <a href='https:\/\/www.dropbox.com\/developers\/apps\/create'>their website<\/a>. Generate yourself a personal key and enter it below:","LANG_TEXT":"Change Lychee language for:","LANG_TITLE":"Change Language","LAYOUT_TEXT":"Use justified layout:","IMAGE_OVERLAY_TEXT":"Display EXIF data overlay by default:","VIEW_NO_RESULT":"No results","VIEW_NO_PUBLIC_ALBUMS":"No public albums","VIEW_NO_CONFIGURATION":"No configuration","VIEW_PHOTO_NOT_FOUND":"Photo not found","NO_TAGS":"No Tags","UPLOAD_MANAGE_NEW_PHOTOS":"You can now manage your new photo(s).","UPLOAD_COMPLETE":"Upload complete","UPLOAD_COMPLETE_FAILED":"Failed to upload one or more photos.","UPLOAD_IMPORTING":"Importing","UPLOAD_IMPORTING_URL":"Importing URL","UPLOAD_UPLOADING":"Uploading","UPLOAD_FINISHED":"Finished","UPLOAD_PROCESSING":"Processing","UPLOAD_FAILED":"Failed","UPLOAD_FAILED_ERROR":"Upload failed. Server returned an error!","UPLOAD_FAILED_WARNING":"Upload failed. Server returned a warning!","UPLOAD_SKIPPED":"Skipped","UPLOAD_ERROR_CONSOLE":"Please take a look at the console of your browser for further details.","UPLOAD_UNKNOWN":"Server returned an unknown response. Please take a look at the console of your browser for further details.","UPLOAD_ERROR_UNKNOWN":"Upload failed. Server returned an unkown error!","UPLOAD_IN_PROGRESS":"Lychee is currently uploading!","UPLOAD_IMPORT_WARN_ERR":"The import has been finished, but returned warnings or errors. Please take a look at the log (Settings -> Show Log) for further details.","UPLOAD_IMPORT_COMPLETE":"Import complete","UPLOAD_IMPORT_INSTR":"Please enter the direct link to a photo to import it:","UPLOAD_IMPORT":"Import","UPLOAD_IMPORT_SERVER":"Importing from server","UPLOAD_IMPORT_SERVER_FOLD":"Folder empty or no readable files to process. Please take a look at the log (Settings -> Show Log) for further details.","UPLOAD_IMPORT_SERVER_INSTR":"This action will import all photos, folders and sub-folders which are located in the following directory. The <b>original files will be deleted<\/b> after the import when possible.","UPLOAD_ABSOLUTE_PATH":"Absolute path to directory","UPLOAD_IMPORT_SERVER_EMPT":"Could not start import because the folder was empty!","ABOUT_SUBTITLE":"Self-hosted photo-management done right","ABOUT_DESCRIPTION":"is a free photo-management tool, which runs on your server or web-space. Installing is a matter of seconds. Upload, manage and share photos like from a native application. Lychee comes with everything you need and all your photos are stored securely."}}`

    } else if (fn == 'Albums::get') {

        data = `{"smartalbums":null,"albums":[{"id":"15460842204911","title":"bridge","public":"1","license":"CC0","sysdate":"December 2018","min_takestamp":"December 1901","max_takestamp":"","password":"0","thumbs":["uploads\/thumb\/a01823195a593057ecd5dd2fbc6f7979.jpeg","uploads\/thumb\/53db8055ab3ae7c1687deaae80bc2b49.jpeg","uploads\/thumb\/6da850d2f1d849fb720ed29a88b84f20.jpeg"],"types":["image\/jpeg","image\/jpeg","image\/jpeg"]},{"id":"15460841921716","title":"cat","public":"1","license":"CC0","sysdate":"December 2018","min_takestamp":"","max_takestamp":"","password":"0","thumbs":["uploads\/thumb\/45347b05b1b4b8d3669566bf951081e6.jpeg"],"types":["image\/jpeg"]},{"id":"15460841698732","title":"Mountain","public":"1","license":"CC0","sysdate":"December 2018","min_takestamp":"April 2008","max_takestamp":"April 2008","password":"0","thumbs":["uploads\/thumb\/3bce728e5264c43e154de84f714e13f8.jpeg","uploads\/thumb\/98aca57af03fb3e7e330424dd5042a42.jpeg"],"types":["image\/jpeg","image\/jpeg"]}],"num":3}`;

    } else if (fn == 'Album::get') {

        if (params.albumID == '15460842204911')
        {
            data = `{"id":"15460842204911","title":"bridge","public":"1","description":"","visible":"1","downloadable":"0","license":"CC0","sysdate":"December 2018","min_takestamp":"December 1901","max_takestamp":"","password":"0","thumbs":[],"types":[],"photos":[{"id":"15460842247095","title":"bridge","description":"","tags":"","public":"0","star":"0","album":"15460842204911","type":"image\/jpeg","width":"300","height":"168","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"","small":"uploads\/small\/a01823195a593057ecd5dd2fbc6f7979.jpeg","thumbUrl":"uploads\/thumb\/a01823195a593057ecd5dd2fbc6f7979.jpeg","url":"uploads\/big\/a01823195a593057ecd5dd2fbc6f7979.jpeg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","previousPhoto":"15460842259285","nextPhoto":"15460842248258"},{"id":"15460842248258","title":"bridge2","description":"","tags":"","public":"0","star":"0","album":"15460842204911","type":"image\/jpeg","width":"3500","height":"1971","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"uploads\/medium\/53db8055ab3ae7c1687deaae80bc2b49.jpg","small":"uploads\/small\/53db8055ab3ae7c1687deaae80bc2b49.jpg","thumbUrl":"uploads\/thumb\/53db8055ab3ae7c1687deaae80bc2b49.jpeg","url":"uploads\/big\/53db8055ab3ae7c1687deaae80bc2b49.jpg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","previousPhoto":"15460842247095","nextPhoto":"15460842259285"},{"id":"15460842259285","title":"bridge3","description":"","tags":"","public":"0","star":"0","album":"15460842204911","type":"image\/jpeg","width":"2272","height":"1704","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"uploads\/medium\/6da850d2f1d849fb720ed29a88b84f20.jpg","small":"uploads\/small\/6da850d2f1d849fb720ed29a88b84f20.jpg","thumbUrl":"uploads\/thumb\/6da850d2f1d849fb720ed29a88b84f20.jpeg","url":"uploads\/big\/6da850d2f1d849fb720ed29a88b84f20.jpg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","previousPhoto":"15460842248258","nextPhoto":"15460842247095"}],"num":3}`;
        }
        else if (params.albumID == '15460841921716')
        {
            data = `{"id":"15460841921716","title":"cat","public":"1","description":"","visible":"1","downloadable":"0","license":"CC0","sysdate":"December 2018","min_takestamp":"","max_takestamp":"","password":"0","thumbs":[],"types":[],"photos":[{"id":"15460841950095","title":"cat","description":"","tags":"","public":"0","star":"0","album":"15460841921716","type":"image\/jpeg","width":"1000","height":"667","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"","small":"uploads\/small\/45347b05b1b4b8d3669566bf951081e6.jpeg","thumbUrl":"uploads\/thumb\/45347b05b1b4b8d3669566bf951081e6.jpeg","url":"uploads\/big\/45347b05b1b4b8d3669566bf951081e6.jpeg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","previousPhoto":"","nextPhoto":""}],"num":1}`;
        }
        else if (params.albumID == '15460841698732')
        {
            data = `{"id":"15460841698732","title":"Mountain","public":"1","description":"","visible":"1","downloadable":"0","license":"CC0","sysdate":"December 2018","min_takestamp":"April 2008","max_takestamp":"April 2008","password":"0","thumbs":[],"types":[],"photos":[{"id":"15460841775505","title":"Montain_in_arosa","description":"","tags":"","public":"0","star":"0","album":"15460841698732","type":"image\/jpeg","width":"3264","height":"2448","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"uploads\/medium\/3bce728e5264c43e154de84f714e13f8.JPG","small":"uploads\/small\/3bce728e5264c43e154de84f714e13f8.JPG","thumbUrl":"uploads\/thumb\/3bce728e5264c43e154de84f714e13f8.jpeg","url":"uploads\/big\/3bce728e5264c43e154de84f714e13f8.JPG","cameraDate":"1","sysdate":"29 December 2018","takedate":"11 April 2008","previousPhoto":"15460841773130","nextPhoto":"15460841773130"},{"id":"15460841773130","title":"montain","description":"","tags":"","public":"0","star":"0","album":"15460841698732","type":"image\/jpeg","width":"900","height":"509","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"","small":"uploads\/small\/98aca57af03fb3e7e330424dd5042a42.jpg","thumbUrl":"uploads\/thumb\/98aca57af03fb3e7e330424dd5042a42.jpeg","url":"uploads\/big\/98aca57af03fb3e7e330424dd5042a42.jpg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","previousPhoto":"15460841775505","nextPhoto":"15460841775505"}],"num":2}`
        }
        else {
            alert('this is just a demo : album unknown');
        }

    } else if (fn == 'Photo::get')
    {
        if (params.photoID == '15460841775505')
        {
            data = `{"id":"15460841775505","title":"Montain_in_arosa","description":"","tags":"","public":"2","star":"0","album":"15460841698732","type":"image\/jpeg","width":"3264","height":"2448","shutter":"1\/250 s","make":"CASIO COMPUTER CO.,LTD.","model":"EX-Z9","iso":"64","aperture":"f\/8.5","focal":"12.8 mm","lens":"","license":"CC0","medium":"uploads\/medium\/3bce728e5264c43e154de84f714e13f8.JPG","small":"uploads\/small\/3bce728e5264c43e154de84f714e13f8.JPG","thumbUrl":"uploads\/thumb\/3bce728e5264c43e154de84f714e13f8.jpeg","url":"uploads\/big\/3bce728e5264c43e154de84f714e13f8.JPG","cameraDate":"1","sysdate":"29 December 2018","takedate":"11 April 2008","original_album":"15460841698732"}`;
        }
        else if (params.photoID == '15460841773130')
        {
            data = `{"id":"15460841773130","title":"montain","description":"","tags":"","public":"2","star":"0","album":"15460841698732","type":"image\/jpeg","width":"900","height":"509","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"","small":"uploads\/small\/98aca57af03fb3e7e330424dd5042a42.jpg","thumbUrl":"uploads\/thumb\/98aca57af03fb3e7e330424dd5042a42.jpeg","url":"uploads\/big\/98aca57af03fb3e7e330424dd5042a42.jpg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","original_album":"15460841698732"}`
        }
        else if (params.photoID == '15460842247095')
        {
            data = `{"id":"15460842247095","title":"bridge","description":"","tags":"","public":"2","star":"0","album":"15460842204911","type":"image\/jpeg","width":"300","height":"168","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"","small":"uploads\/small\/a01823195a593057ecd5dd2fbc6f7979.jpeg","thumbUrl":"uploads\/thumb\/a01823195a593057ecd5dd2fbc6f7979.jpeg","url":"uploads\/big\/a01823195a593057ecd5dd2fbc6f7979.jpeg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","original_album":"15460842204911"}`
        }
        else if (params.photoID == '15460842248258')
        {
            data = `{"id":"15460842248258","title":"bridge2","description":"","tags":"","public":"2","star":"0","album":"15460842204911","type":"image\/jpeg","width":"3500","height":"1971","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"uploads\/medium\/53db8055ab3ae7c1687deaae80bc2b49.jpg","small":"uploads\/small\/53db8055ab3ae7c1687deaae80bc2b49.jpg","thumbUrl":"uploads\/thumb\/53db8055ab3ae7c1687deaae80bc2b49.jpeg","url":"uploads\/big\/53db8055ab3ae7c1687deaae80bc2b49.jpg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","original_album":"15460842204911"}`
        }
        else if (params.photoID == '15460842259285')
        {
            data = `{"id":"15460842259285","title":"bridge3","description":"","tags":"","public":"2","star":"0","album":"15460842204911","type":"image\/jpeg","width":"2272","height":"1704","shutter":"0.0067750677506775 s","make":"NIKON","model":"E4300","iso":"100","aperture":"f\/7.6","focal":"8 mm","lens":"","license":"CC0","medium":"uploads\/medium\/6da850d2f1d849fb720ed29a88b84f20.jpg","small":"uploads\/small\/6da850d2f1d849fb720ed29a88b84f20.jpg","thumbUrl":"uploads\/thumb\/6da850d2f1d849fb720ed29a88b84f20.jpeg","url":"uploads\/big\/6da850d2f1d849fb720ed29a88b84f20.jpg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","original_album":"15460842204911"}`
        }
        else if (params.photoID == '15460841950095')
        {
            data = `{"id":"15460841950095","title":"cat","description":"","tags":"","public":"2","star":"0","album":"15460841921716","type":"image\/jpeg","width":"1000","height":"667","shutter":"","make":"","model":"","iso":"","aperture":"","focal":"","lens":"","license":"CC0","medium":"","small":"uploads\/small\/45347b05b1b4b8d3669566bf951081e6.jpeg","thumbUrl":"uploads\/thumb\/45347b05b1b4b8d3669566bf951081e6.jpeg","url":"uploads\/big\/45347b05b1b4b8d3669566bf951081e6.jpeg","cameraDate":"0","sysdate":"29 December 2018","takedate":"","original_album":"15460841921716"}`
        }
        else {
            alert('this is just a demo : photo unknown');
        }
    }
    else {
...
build.iconic = function (icon) {
	...
	html += lychee.html(_templateObject10, classes, icon);
...
build.divider = function (title) {
	...
	html += lychee.html(_templateObject11, title);
...
build.editIcon = function (id) {
	...
	html += lychee.html(_templateObject12, id, build.iconic('pencil'));
...
build.multiselect = function (top, left) {
	...
	return lychee.html(_templateObject13, top, left);
};
...
build.album = function (data) {
	...
	html += lychee.html(_templateObject14, disabled ? "disabled" : "", data.id, build.getThumbnailHtml(data.thumbs[2], data.thumbs[2], data.types[2]), build.getThumbnailHtml(data.thumbs[1], data.thumbs[1], data.types[1]), build.getThumbnailHtml(data.thumbs[0], data.thumbs[0], data.types[0]), data.title, data.title, date_stamp);

	if (lychee.publicMode === false) {

		html += lychee.html(_templateObject15, data.star === '1' ? 'badge--star' : '', build.iconic('star'), data.public === '1' ? 'badge--visible' : '', data.hidden === '1' ? 'badge--not--hidden' : 'badge--hidden', build.iconic('eye'), data.unsorted === '1' ? 'badge--visible' : '', build.iconic('list'), data.recent === '1' ? 'badge--visible badge--list' : '', build.iconic('clock'), data.password === '1' ? 'badge--visible' : '', build.iconic('lock-locked'));
	}
...
build.photo = function (data) {
	...
	html += lychee.html(_templateObject16, data.album, data.id, build.getThumbnailHtml(data.thumbUrl, retinaThumbUrl, data.type, data.medium, data.small), data.title, data.title);

	if (data.cameraDate === '1') html += lychee.html(_templateObject17, build.iconic('camera-slr'), data.takedate);else html += lychee.html(_templateObject18, data.sysdate);

	html += "</div>";

	if (lychee.publicMode === false) {

		html += lychee.html(_templateObject19, data.star === '1' ? 'badge--star' : '', build.iconic('star'), data.public === '1' && album.json.public !== '1' ? 'badge--visible' : '', build.iconic('eye'));
	}
...
build.overlay_image = function (data) {
	...
	if (exifHash !== '') {
		html += lychee.html(_templateObject20, data.title, data.shutter.replace('s', 'sec'), data.aperture.replace('f/', '&fnof; / '), lychee.locale['PHOTO_ISO'], data.iso, data.focal, data.lens && data.lens !== '' ? '(' + data.lens + ')' : '');
	}
...
build.imageview = function (data, visibleControls) {
	...
	if (data.type.indexOf('video') > -1) {
		html += lychee.html(_templateObject21, visibleControls === true ? '' : 'full', data.url);
	} else {
		html += lychee.html(_templateObject22, visibleControls === true ? '' : 'full', data.medium !== '' ? data.medium : data.url);
...
build.no_content = function (typ) {
	...
	html += lychee.html(_templateObject23, build.iconic(typ));

	switch (typ) {
		case 'magnifying-glass':
			html += lychee.html(_templateObject24, lychee.locale['VIEW_NO_RESULT']);
			break;
		case 'eye':
			html += lychee.html(_templateObject24, lychee.locale['VIEW_NO_PUBLIC_ALBUMS']);
			break;
		case 'cog':
			html += lychee.html(_templateObject24, lychee.locale['VIEW_NO_CONFIGURATION']);
			break;
		case 'question-mark':
			html += lychee.html(_templateObject24, lychee.locale['VIEW_PHOTO_NOT_FOUND']);
			break;
	}
...
build.uploadModal = function (title, files) {
	...
	html += lychee.html(_templateObject25, title);
	...
	while (i < files.length) {
		...
		html += lychee.html(_templateObject26, file.name);
...
build.tags = function (tags) {
	...
	if (tags !== '') {
		...
		tags.forEach(function (tag, index, array) {
			html += lychee.html(_templateObject27, tag, index, build.iconic('x'));
		});
	} else {

		html = lychee.html(_templateObject28, lychee.locale['NO_TAGS']);
	}
...
build.user = function (user) {
	var html = lychee.html(_templateObject29, user.id, user.id, user.username, user.id, user.id);
	...
	while (i < lists.length) {
		if (layer === 0 && !lists[i].parent_id || lists[i].parent_id === parent) {
			(function () {
				...
				var html = lychee.html(_templateObject30, prefix, thumb, item.title);
	...
	api.post('Albums::get', {}, function (data) {
		...
		if (data.albums && data.albums.length > 0) {
			...
			for (i = 0; i < IDs.length; i++) {
				var sub = contextMenu.getSubIDs(data.albums, IDs[i]);
			...
			items = items.concat(contextMenu.buildList(data.albums, exclude.concat(IDs), function (a) {
...
header.setTitle = function () {
	...
	var html = lychee.html(_templateObject31, title, build.iconic('caret-bottom'));
...
leftMenu.build = function () {
	var html = lychee.html(_templateObject32, lychee.locale['SETTINGS']);
	if (lychee.api_V2) {
		html += lychee.html(_templateObject33, build.iconic('person'), lychee.locale['USERS'], build.iconic('cloud'), lychee.locale['SHARING']);
	}
	html += lychee.html(_templateObject34, build.iconic('align-left'), lychee.locale['LOGS'], build.iconic('wrench'), lychee.locale['DIAGNOSTICS'], build.iconic('info'), lychee.locale['ABOUT_LYCHEE'], build.iconic('account-logout'), lychee.locale['SIGN_OUT']);
...
lychee.aboutDialog = function () {
	...
	var msg = lychee.html(_templateObject35, lychee.version, lychee.updateURL, lychee.locale['UPDATE_AVAILABLE'], lychee.locale['ABOUT_SUBTITLE'], lychee.website, lychee.locale['ABOUT_DESCRIPTION']);
...
lychee.loginDialog = function () {
	...
	var msg = lychee.html(_templateObject36, lychee.locale['USERNAME'], lychee.locale['PASSWORD'], lychee.version, lychee.updateURL, lychee.locale['UPDATE_AVAILABLE']);
...
photo.delete = function (photoIDs) {
	...
	if (photoIDs.length === 1) {
		...
		msg = lychee.html(_templateObject37, lychee.locale['PHOTO_DELETE_1'], photoTitle, lychee.locale['PHOTO_DELETE_2']);
	} else {

		action.title = lychee.locale['PHOTO_DELETE'];
		cancel.title = lychee.locale['PHOTO_KEEP'];

		msg = lychee.html(_templateObject38, lychee.locale['PHOTO_DELETE_ALL_1'], photoIDs.length, lychee.locale['PHOTO_DELETE_ALL_2']);
	}
...
photo.setTitle = function (photoIDs) {
	...
	var input = lychee.html(_templateObject39, oldTitle);

	if (photoIDs.length === 1) msg = lychee.html(_templateObject2, lychee.locale['PHOTO_NEW_TITLE'], input);else msg = lychee.html(_templateObject40, lychee.locale['PHOTOS_NEW_TITLE_1'], photoIDs.length, lychee.locale['PHOTOS_NEW_TITLE_2'], input);
...
photo.setDescription = function (photoID) {
	...
	basicModal.show({
		body: lychee.html(_templateObject41, lychee.locale['PHOTO_NEW_DESCRIPTION'], lychee.locale['PHOTO_DESCRIPTION'], oldDescription),
		buttons: {
			action: {
...
photo.editTags = function (photoIDs) {
	...
	var input = lychee.html(_templateObject42, oldTags);

	if (photoIDs.length === 1) msg = lychee.html(_templateObject2, lychee.locale['PHOTO_NEW_TAGS'], input);else msg = lychee.html(_templateObject40, lychee.locale['PHOTO_NEW_TAGS_1'], photoIDs.length, lychee.locale['PHOTO_NEW_TAGS_2'], input);
...
sidebar.render = function (structure) {
	...
	var renderDefault = function renderDefault(section) {
		...
		section.rows.forEach(function (row) {
			...
			value = lychee.html(_templateObject43, row.kind, value);

			// Add edit-icon to the value when editable
			if (row.editable === true) value += ' ' + build.editIcon('edit_' + row.kind);

			_html += lychee.html(_templateObject44, row.title, value);
		});
	...
	var renderTags = function renderTags(section) {
		...
		_html += lychee.html(_templateObject45, section.title, section.title.toLowerCase(), section.value, editable);
...
upload.start = {
	...
	url: function url() {
		...
		basicModal.show({
			body: lychee.html(_templateObject46) + lychee.locale['UPLOAD_IMPORT_INSTR'] + (" <input class='text' name='link' type='text' placeholder='http://' value='" + _url + "'></p>"),
			buttons: {
				action: {
	...
	server: function server() {
		...
		basicModal.show({
			body: lychee.html(_templateObject46) + lychee.locale['UPLOAD_IMPORT_SERVER_INSTR'] + " <input class='text' name='path' type='text' maxlength='100' placeholder='" + lychee.locale['UPLOAD_ABSOLUTE_PATH'] + ("' value='" + lychee.location + "uploads/import/'></p>"),
			buttons: {
				action: {
					title: lychee.locale['UPLOAD_IMPORT'],
					fn: action
...
view.photo = {
	...
	photo: function (_photo) {
		...
		if (hasNext === false || lychee.viewMode === true) {
			...
			$nextArrow.css('background-image', lychee.html(_templateObject47, nextPhoto.thumbUrl));
		}
		...
		if (hasPrevious === false || lychee.viewMode === true) {
			...
			$previousArrow.css('background-image', lychee.html(_templateObject47, previousPhoto.thumbUrl));
		}
	}),
