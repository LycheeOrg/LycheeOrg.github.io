...
<div class="donations">
    ...
    <p class="contributors">
        <img class="avatar" src="https://avatars1.githubusercontent.com/u/3878010?s=400&v=4">
        <span>
            bennettscience (Brian)<br>
            <a href="https://github.com/bennettscience">GitHub</a>
             - <a class="donate" href="https://www.paypal.me/bebennett"><i class="fab fa-paypal"></i> Donate</a>
        </span>
    </p>
